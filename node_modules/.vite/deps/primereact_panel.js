...
var Panel = React3.forwardRef(function(inProps, ref) {
  ...
  var createToggleIcon = function createToggleIcon2() {
    if (props.toggleable) {
      ...
      return React3.createElement("button", togglerProps, toggleIcon, React3.createElement(Ripple, null));
    }
    return null;
  };
  var createHeader = function createHeader2() {
    ...
    var titleElement = React3.createElement("span", titleProps, header2);
    var iconsProps = mergeProps({
      className: cx("icons")
    }, ptm("icons"));
    var iconsElement = React3.createElement("div", iconsProps, icons, togglerElement);
    var headerProps = mergeProps({
      className: cx("header")
    }, ptm("header"));
    var content2 = React3.createElement("div", headerProps, titleElement, iconsElement);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React3.createElement("div", footerProps, footer2);
  ...
  var createContent = function createContent2() {
    ...
    return React3.createElement(CSSTransition, _extends3({
      nodeRef: contentRef
    }, transitionProps), React3.createElement("div", toggleableContentProps, React3.createElement("div", contentProps, props.children)));
  };
  ...
  return React3.createElement("div", rootProps, header, content, footer);
});
