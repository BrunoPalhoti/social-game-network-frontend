...
import {
  Ripple
} from "./chunk-WN5KFEQP.js";
import {
  IconBase
} from "./chunk-P4CAF6BN.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
...
var TabView = React4.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React4.useState(true), _React$useState4 = _slicedToArray(_React$useState3, 2), backwardIsDisabledState = _React$useState4[0], setBackwardIsDisabledState = _React$useState4[1];
  var _React$useState5 = React4.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), forwardIsDisabledState = _React$useState6[0], setForwardIsDisabledState = _React$useState6[1];
  var _React$useState7 = React4.useState([]), _React$useState8 = _slicedToArray(_React$useState7, 2), hiddenTabsState = _React$useState8[0], setHiddenTabsState = _React$useState8[1];
  var _React$useState9 = React4.useState(props.activeIndex), _React$useState10 = _slicedToArray(_React$useState9, 2), activeIndexState = _React$useState10[0], setActiveIndexState = _React$useState10[1];
  var elementRef = React4.useRef(null);
  var contentRef = React4.useRef(null);
  var navRef = React4.useRef(null);
  var inkbarRef = React4.useRef(null);
  var prevBtnRef = React4.useRef(null);
  var nextBtnRef = React4.useRef(null);
  var tabsRef = React4.useRef({});
  var activeIndex = props.onTabChange ? props.activeIndex : activeIndexState;
  var count = React4.Children.count(props.children);
  var metaData = {
    props,
    state: {
      id: idState,
  ...
  var findVisibleActiveTab = function findVisibleActiveTab2(i) {
    var tabsInfo = React4.Children.map(props.children, function(tab, index) {
      if (shouldUseTab(tab)) {
        return {
          tab,
          index
  ...
  var onPageDownKey = function onPageDownKey2(event) {
    updateScrollBar({
      index: React4.Children.count(props.children) - 1
    });
    event.preventDefault();
  };
  ...
  var createTabHeader = function createTabHeader2(tab, index) {
    ...
    var titleElement = React4.createElement("span", headerTitleProps, header3);
    ...
    var icon = closeIcon || React4.createElement(TimesIcon, closeIconProps);
    ...
    var content4 = (
      // eslint-disable /
      React4.createElement("a", headerActionProps, leftIconElement, titleElement, rightIconElement, closableIconElement, React4.createElement(Ripple, null))
    );
    if (headerTemplate) {
    ...
    return React4.createElement("li", headerProps, content4);
  };
  var createTabHeaders = function createTabHeaders2() {
    return React4.Children.map(props.children, function(tab, index) {
      if (shouldUseTab(tab)) {
  ...
  var createNavigator = function createNavigator2() {
    ...
    return React4.createElement("div", navContentProps, React4.createElement("ul", navProps, headers, React4.createElement("li", inkbarProps)));
  };
  var createContent = function createContent2() {
    ...
    var contents = React4.Children.map(props.children, function(tab, index) {
      if (shouldUseTab(tab) && (!props.renderActiveOnly || isSelected(index))) {
        ...
        return React4.createElement("div", contentProps, !props.renderActiveOnly ? getTabProp(tab, "children") : selected && getTabProp(tab, "children"));
      }
    });
    return React4.createElement("div", panelContainerProps, contents);
  };
  var createPrevButton = function createPrevButton2() {
    var prevIconProps = mergeProps({
      "aria-hidden": "true"
    }, ptm("previcon"));
    var icon = props.prevButton || React4.createElement(ChevronLeftIcon, prevIconProps);
    ...
    if (props.scrollable && !backwardIsDisabledState) {
      return React4.createElement("button", prevButtonProps, leftIcon, React4.createElement(Ripple, null));
    }
    return null;
  };
  var createNextButton = function createNextButton2() {
    ...
    var icon = props.nextButton || React4.createElement(ChevronRightIcon, nextIconProps);
    ...
    if (props.scrollable && !forwardIsDisabledState) {
      return React4.createElement("button", nextButtonProps, rightIcon, React4.createElement(Ripple, null));
    }
  };
  ...
  return React4.createElement("div", rootProps, React4.createElement("div", navContainerProps, prevButton, navigator, nextButton), content3);
});
