...
import {
  IconBase
} from "./chunk-V7JEXFDJ.js";
import {
  InputText
} from "./chunk-TAXQBKBM.js";
import {
  Portal
} from "./chunk-F3UXGYKW.js";
import {
  require_react_dom
...
var IconField = import_react8.default.memo(import_react8.default.forwardRef(function(inProps, ref) {
  ...
  return import_react8.default.createElement("div", _extends4({}, rootProps, {
    ref: elementRef
  }), import_react8.Children.map(props.children, function(child, index) {
...
var Password = React10.memo(React10.forwardRef(function(inProps, ref) {
  ...
  var _useOverlayListener = useOverlayListener({
    ...
    listener: function listener(event, _ref) {
      var valid = _ref.valid, type2 = _ref.type;
      if (valid) {
        if (type2 === "outside" || context.hideOverlaysOnDocumentScrolling) {
          hide();
  ...
  if (icon) {
    ...
    }, input2, React10.createElement(InputIcon, {
